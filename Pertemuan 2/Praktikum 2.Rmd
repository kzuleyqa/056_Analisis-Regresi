...
data <- read_excel("C:\\Users\\Asus Vivobook\\OneDrive\\Documents\\Kuliah\\Semester 4\\ANREG\\P2\\Data excel pertemuan 2.xlsx", sheet="Sheet2")
...
plot(data$X6, data$Y,
     ...
     xlab = "Pertumbuhan Ekonomi Sektor Industri Pengolahan",
     ylab = "IPM")
```
...
$$\hat{Y} = 79.7117 - 0.8222 X_6$$

dengan Y adalah Indeks Pembangunan Manusia dan X6 adalah Pertumbuhan Ekonomi Sektor Industri Pengolahan

Didapatkan nilai $\hat\beta_0 = 79.7117$ artinya nilai dugaan rataan indeks pembangunan manusia ketika Pertumbuhan Ekonomi Sektor Industri Pengolahan bernilai 0 persen adalah 79.7117%, akan tetapi nilai 0 tidak ada dalam selang pengamatan Pertumbuhan Ekonomi Sektor Industri Pengolahan sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = - 2.87498$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Pertumbuhan Ekonomi Sektor Industri Pengolahan berubah satu tahun adalah sebesar - 2.875%
